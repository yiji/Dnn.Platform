<%@ Control Language="C#" AutoEventWireup="false" CodeBehind="ucSubmitNews.ascx.cs" Inherits="GcDesign.NewsArticles.ucSubmitNews" %>
<%@ Register TagPrefix="dnn" TagName="Label" Src="~/controls/LabelControl.ascx" %>
<%@ Register TagPrefix="dnn" TagName="SectionHead" Src="~/controls/SectionHeadControl.ascx" %>
<%@ Register TagPrefix="dnn" TagName="URL" Src="~/controls/URLControl.ascx" %>
<%@ Register TagPrefix="dnn" TagName="TextEditor" Src="~/controls/TextEditor.ascx"%>
<%@ Register Assembly="GcDesign.NewsArticles" Namespace="GcDesign.NewsArticles.Components.Validators" TagPrefix="GcDesign" %>
...
<dnn:DnnJsInclude runat="server" FilePath="~/DesktopModules/GcDesign-NewsArticles/Includes/Uploader/swfupload.00.07.61.js" />
<dnn:DnnJsInclude runat="server" FilePath="~/DesktopModules/GcDesign-NewsArticles/Includes/Uploader/handlers.00.07.61.js" />
