<%@ Control Language="C#" AutoEventWireup="false" CodeBehind="ucImportFeeds.ascx.cs" Inherits="GcDesign.NewsArticles.ucImportFeeds" %>
...
<asp:datagrid id="grdFeeds" Border="0" CellPadding="4" CellSpacing="0" Width="100%" AutoGenerateColumns="false" EnableViewState="false" runat="server" summary="Feeds Design Table" GridLines="None">
	<Columns>
		<asp:TemplateColumn ItemStyle-Width="20">
			<ItemTemplate>
				<asp:HyperLink ID="HyperLink1" NavigateUrl='<%# DotNetNuke.Common.Globals.NavigateURL(this.TabId, "ImportFeed", "mid="+this.ModuleId.ToString(), "FeedID="+DataBinder.Eval(Container.DataItem,"FeedID").ToString()) %>' runat="server">
