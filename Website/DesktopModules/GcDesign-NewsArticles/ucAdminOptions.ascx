<%@ Control Language="C#" AutoEventWireup="false" CodeBehind="ucAdminOptions.ascx.cs" Inherits="GcDesign.NewsArticles.ucAdminOptions" %>
<%@ Register TagPrefix="GcDesign" TagName="Header" Src="ucHeader.ascx" %>
<GcDesign:Header id="ucHeader1" SelectedMenu="AdminOptions" runat="server" MenuPosition="Top" />
...
<GcDesign:Header id="ucHeader2" SelectedMenu="AdminOptions" runat="server" MenuPosition="Bottom" />
