<%@ Control Language="C#" AutoEventWireup="false" CodeBehind="ucEditPageSortOrder.ascx.cs" Inherits="GcDesign.NewsArticles.ucEditPageSortOrder" %>
...
<p>
	<asp:linkbutton id="cmdUpdate" resourcekey="cmdUpdate" runat="server" cssclass="CommandButton" text="Update" borderstyle="none" OnDataBinding="cmdUpdate_Click" />
	&nbsp;
