<%@ Control Language="C#" AutoEventWireup="false" CodeBehind="ucEditCustomFields.ascx.cs" Inherits="GcDesign.NewsArticles.ucEditCustomFields" %>
...
<asp:datagrid id="grdCustomFields" Border="0" CellPadding="4" width="100%" AutoGenerateColumns="false"
	...
	<Columns>
        ...
        <asp:BoundColumn HeaderText="ID" DataField="CustomFieldID" ItemStyle-CssClass="Normal" HeaderStyle-Cssclass="NormalBold" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left" ItemStyle-Width="100px" />
