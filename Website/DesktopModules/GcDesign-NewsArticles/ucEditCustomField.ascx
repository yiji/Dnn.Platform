<%@ Control Language="C#" AutoEventWireup="false" CodeBehind="ucEditCustomField.ascx.cs" Inherits="GcDesign.NewsArticles.ucEditCustomField" %>
...
<tr>
    <td width="560" valign="top">
        ...
        <TABLE id="tblCustomFieldDetails" cellSpacing="0" cellPadding="2" width="100%" summary="Custom Field Details Design Table"
            ...
            <TR vAlign="top" id="FieldID" runat="server" visible="false">
		        <TD width="25"><IMG height=1 src='<%= Page.ResolveUrl("~/Images/Spacer.gif") %>' width=25></TD>
		        <TD class="SubHead" noWrap width="150"><dnn:label id="plFieldID" runat="server" resourcekey="ID" suffix=":" controlname="txtFieldID"></dnn:label></TD>
		        <TD align="left" width="100%">
			        <asp:textbox id="txtFieldID" cssclass="NormalTextBox" runat="server" maxlength="255" columns="30"
