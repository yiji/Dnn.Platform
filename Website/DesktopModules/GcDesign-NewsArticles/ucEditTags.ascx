<%@ Control Language="C#" AutoEventWireup="false" CodeBehind="ucEditTags.ascx.cs" Inherits="GcDesign.NewsArticles.ucEditTags" %>
...
<asp:datagrid id="grdTags" Border="0" CellPadding="4" CellSpacing="0" Width="100%" AutoGenerateColumns="false" EnableViewState="false" runat="server" summary="Pages Design Table" GridLines="None">
	<Columns>
		<asp:TemplateColumn ItemStyle-Width="20">
			<ItemTemplate>
				<asp:HyperLink NavigateUrl='<%# DotNetNuke.Common.Globals.NavigateURL(TabId, "EditTag", "mid=" + ModuleId.ToString(), "TagID=" + DataBinder.Eval(Container.DataItem,"TagID").ToString()) %>' runat="server" ID="Hyperlink1">
