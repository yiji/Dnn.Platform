<%@ Control Language="C#" AutoEventWireup="false" CodeBehind="UploadImages.ascx.cs" Inherits="GcDesign.NewsArticles.Controls.UploadImages" %>
<%@ Register TagPrefix="GcDesign" Assembly="GcDesign.NewsArticles" Namespace="GcDesign.NewsArticles.Components.WebControls" %>
	                    ...
	                    <tr>
	                        <td>
	                            ...
	                            <tr>
							        ...
							        <td valign="top"><br />&nbsp;<asp:LinkButton ID="cmdAddExistingImage" runat="server" ResourceKey="cmdAddExistingImage" CausesValidation="false" CssClass="CommandButton" Text="AddExistingImage"  /></td>
	                            </tr>
	                            </table>
						    </td>
		                </tr>
	            ...
	            <tr>
	                <td>
	                    <asp:DataList CellPadding="4" CellSpacing="0" ID="dlImages" Runat="server" RepeatColumns="4" RepeatDirection="Horizontal" DataKeyField="ImageID" >
				            ...
				            <ItemTemplate>
					            <img src='<%# GetImageUrl((GcDesign.NewsArticles.ImageInfo)Container.DataItem) %>' alt="Photo"><br />
					            <b>
...
<GcDesign:RefreshControl ID="cmdRefreshPhotos" runat="server" Text="Refresh Photos" Visible="false" />