<%@ Control Language="C#" AutoEventWireup="false" CodeBehind="PostComment.ascx.cs" Inherits="GcDesign.NewsArticles.Controls.PostComment" %>
...
<asp:PlaceHolder ID="phCommentForm" runat="Server">
    ...
    <p>
        <asp:Label ID="lblCourse" runat="server" CssClass="Normal w" Text="课程名" />
