<%@ Control Language="C#" AutoEventWireup="false" CodeBehind="PostComment2.ascx.cs" Inherits="GcDesign.NewsArticles.Controls.PostComment2" %>
...
<asp:PlaceHolder ID="phCommentForm" runat="Server">
    ...
    <p>
        <asp:Label ID="lblCourse" runat="server" CssClass="Normal w" Text="软件名" />
    ...
    <p class="submitBtn">
        <asp:Button ID="btnAddComment" runat="server" Text="我要询价" ValidationGroup="PostComment" UseSubmitBehavior="false" />
    </p>
</asp:PlaceHolder>
