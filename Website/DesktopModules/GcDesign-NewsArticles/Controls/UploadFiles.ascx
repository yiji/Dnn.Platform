<%@ Control Language="C#" AutoEventWireup="false" CodeBehind="UploadFiles.ascx.cs" Inherits="GcDesign.NewsArticles.Controls.UploadFiles" %>
...
<GcDesign:RefreshControl ID="cmdRefreshFiles" runat="server" Text="Refresh Files" Visible="false" />