...
{
    public partial class PostComment1 : NewsArticleControlBase
    {
        ...
        public string GetResourceKey(string key)
        {
            ...
            string path = @"~/DesktopModules/GcDesign-NewsArticles/" + Localization.LocalResourceDirectory + @"/PostComment.ascx.resx";
