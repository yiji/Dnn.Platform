<%@ Control Language="C#" AutoEventWireup="false" CodeBehind="ucEditCategory.ascx.cs" Inherits="GcDesign.NewsArticles.ucEditCategory" %>
          ...
          <tr>
	        ...
	        <tr>
	            ...
	            <td colspan="2">
                    ...
                    <tr>
                        <td class="auto-style1" width="150"><dnn:label id="plMetaKeyWords" runat="server" suffix=":" controlname="txtMetaKeyWords"></dnn:label></td>
