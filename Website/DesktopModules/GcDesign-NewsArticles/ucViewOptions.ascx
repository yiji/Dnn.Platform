<%@ Control Language="C#" AutoEventWireup="false" CodeBehind="ucViewOptions.ascx.cs" Inherits="GcDesign.NewsArticles.ucViewOptions" %>
				...
				<tr>
					...
					<td valign="top" width="475">
						...
						<table id="tblCategory" cellspacing="2" cellpadding="2" summary="Appearance Design Table"
                            ...
                            <tr>
								<td class="SubHead" width="200"><dnn:label id="plArticleBreadcrumb" resourcekey="ArticleBreadcrumb" runat="server"
										controlname="chkArticleBreadcrumb"></dnn:label></td>
								<td valign="top"><asp:checkbox id="chkArticleBreadcrumb" Runat="server" CssClass="NormalTextBox"></asp:checkbox></td>
							</tr>
							<tr>
						...
						<table id="tblFilter" cellspacing="2" cellpadding="2" summary="Filter Details Design Table"
							border="0" runat="server">
							<tr>
								<td class="auto-style1" width="200"><dnn:label id="plMaxArticles" runat="server" resourcekey="MaxArticles" suffix=":" controlname="txtMaxArticles"></dnn:label></td>
