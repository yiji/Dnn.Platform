var DnnSpaModuleTest = DnnSpaModuleTest || {};

DnnSpaModuleTest.itemViewModel = function (moduleId, resx) {
    var service = {
        path: "DnnSpaModuleTest",
    ...
    var loadUsers = function (data) {
        ...
        for (var i = 0; i < data.length; i++) {
            var result = data[i];
            var user = new DnnSpaModuleTest.user(result.id, result.name);
...
DnnSpaModuleTest.user = function (id, name) {
    this.id = id;
    this.name = name;
}